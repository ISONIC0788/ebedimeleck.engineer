      ...
      <div className="row align-items-center">
        ...
        <div className="col-md-7">
          <h1 className="fw-bold title-text">
            ...
            <br />& IT Student, shaping solutions with open-source.
          </h1>
          ...
          <p className="mt-3 lead-text">
            H's currently Building my empire in technology called{" "}
            <strong>Ebyte Code Labs</strong>, a tech hub that transforms ideas
            into meaningful solutions—whether it's job-matching platforms,
          ...
          <p className="mt-3 lead-text">
            ...
            <strong>problem-solver with purpose</strong>,
        ...
        <div className="col-md-5 text-center mt-4 mt-md-0">
          ...
          <div className="mt-5 d-flex flex-column gap-3 align-items-start social-links">
            ...
            <a
              ...
              className="mt-3 border-top px-4 py-4"
            >
            ...
            >
              <FaUserTie className="me-2" /> My Mentor:{" "}
              <strong className="fw-bold">karinganire Anathole</strong> <br />
              <span className="lead-text d-block mt-2">
                Guided by vision and excellence — check out my mentor’s work
                that inspires my journey.
              </span>
              {/* Mentor Links */}
